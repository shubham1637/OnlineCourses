...
def do_PCA(armadillo):
  ...
  pca.fit(armadillo) # This just fits the model. Fitting the data just calculates the basis of the lower dimensional encoding.
  T = pca.transform(armadillo) # This applies dimensionality reduction
  return T
