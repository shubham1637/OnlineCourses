...
#
mat = scipy.io.loadmat('C:/Users/shubh/Documents/Github/DAT210x/Module4/Datasets/face_data.mat')
...
# loaded it correctly.
#
y = pd.read_csv('Datasets/face_labels.csv', header = None)[0]
# y = pd.Series.from_csv('Datasets/face_labels.csv', header = None, index_col = None)
#
...
# test_size from 0.15 (15%). Your labels are actually passed in as a series
...
if Test_PCA:
  ...
  pca.fit(data_train)
  T_train = pca.transform(data_train)
  T_test = pca.transform(data_test)
  ...
  iso.fit(data_train)
  T_train = iso.transform(data_train)
  T_test = iso.transform(data_test)
...
Plot2DBoundary(knn, T_train, label_train, T_test, label_test)
