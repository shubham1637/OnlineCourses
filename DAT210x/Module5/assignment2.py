...
#
user1 = df[df.In == users[0]].reset_index(drop = True)
...
#
user1 = df[(df.In == users[0]) & ((df.DOW == 'Sat') | (df.DOW == 'Sun'))].reset_index(drop = True)
...
#
user1 = user1[(user1.CallTime > "22:00:00") | (user1.CallTime < "06:00:00")].reset_index(drop = True)
