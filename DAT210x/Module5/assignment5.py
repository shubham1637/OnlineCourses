...
#
Nrmlzr = preprocessing.Normalizer().fit(data_train)
...
#
X_train = Nrmlzr.transform(data_train)
X_test = Nrmlzr.transform(data_test)
...
plotDecisionBoundary(knn, T_train, label_train)
