...
# For each audio file, simply append the audio_data (not the sample_rate,
# just the data!) to your Python list 'zero':
#
zero = list()
import os
directory = "Datasets/Assignment10/"
...
#
X_test = test[0 : int(Provided_Portion*n_audio_samples) + 1]
...
#
y_test = test[int(Provided_Portion*n_audio_samples) + 1: ]
...
#
X_train = train[:, 0 :int(Provided_Portion*n_audio_samples) + 1]
y_train = train[:, int(Provided_Portion*n_audio_samples) + 1: ]
