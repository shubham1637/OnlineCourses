...
# problematic
#
X[['how_tall_in_meters', 'body_mass_index']] = X[['how_tall_in_meters', 'body_mass_index']].apply(pd.to_numeric, errors = 'raise')
X= X.drop(122076, axis = 0).reset_index(drop = True)
